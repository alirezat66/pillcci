...
package greencode.ir.pillcci.timepicker.wheel;
...
import greencode.ir.pillcci.timepicker.adapters.WheelViewAdapter;
import greencode.ir.pillcci.timepicker.config.DefaultConfig;
...
//        mPaintLineRight.setStrokeWidth(context.getResources().getDimensionPixelSize(R.dimen.picker_line_width));
   ...
   /* private void init(Context context) {
        setTypeface(Utility.getRegularTypeFace(context));
    }*/
