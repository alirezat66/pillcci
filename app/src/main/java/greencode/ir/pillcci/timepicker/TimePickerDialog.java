...
import greencode.ir.pillcci.timepicker.data.WheelCalendar;
    ...
    */
    ...
    public static class Builder {
        ...
        public Builder setHourText(String hour){
            String s =  Utility.convertToPersianDigits(hour);
            mPickerConfig.mHour = s;
            return this;
        }

        public Builder setMinuteText(String minute){
            String min = Utility.convertToPersianDigits(minute);
            mPickerConfig.mMinute = min;
            return this;
        }
