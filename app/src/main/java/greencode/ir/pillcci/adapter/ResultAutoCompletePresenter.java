...
public class ResultAutoCompletePresenter extends RecyclerViewPresenter<String> {

    protected Adapter adapter;
    public ArrayList<String> results = new ArrayList<>();
    public ResultAutoCompletePresenter(Context context) {
        super(context);
        AppDatabase database = AppDatabase.getInMemoryDatabase(context);
        results = new ArrayList<>(database.pillObjectDao().getReults());
    }
