...
public class OurPillAutoCompletePresenter extends RecyclerViewPresenter<String> {

    protected Adapter adapter;
    public ArrayList<String> pils = new ArrayList<>();
    public ArrayList<String> tempPils = new ArrayList<>();

    public OurPillAutoCompletePresenter(Context context) {
        super(context);

        AppDatabase database = AppDatabase.getInMemoryDatabase(context);
        pils = new ArrayList<>(database.pillObjectDao().getAllPillNames());
    }
