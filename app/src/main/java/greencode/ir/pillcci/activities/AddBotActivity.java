...
public class AddBotActivity extends BaseActivity implements BotAddInterface {
    ...
    private void insertPhone() {
        ...
        BotObject object = new BotObject(edtFName.getText()+" "+edtLName.getText(),edtPhone.getText().toString(),b64Image);
        kProgressHUD = Utility.makeWaiting("لطفا منتظر بمانید","در حال اضافه کردن فرد به بات",this);
        kProgressHUD.show();
    ...
    private void showDialogForImageSelector() {
        ...
        dialog.setListener(new PhotoChoserInterface() {
            ...
            public void onSuccess(int type) {
                ...
                if (type == 1) {
                    EasyImage.openCamera(AddBotActivity.this, 500);
                    //camera chosemn
                } else {
                    EasyImage.openGallery(AddBotActivity.this, 600);
                    //gallery chosen
                }
                dialog.dismiss();
            }
    ...
    public void onSuccess() {
        kProgressHUD.dismiss();
        Toast.makeText(this, "برای شماره مورد نظر درخواست ارسال شد.", Toast.LENGTH_SHORT).show();
        finish();
    }
